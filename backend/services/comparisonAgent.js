...
/**
 * Comparison Agent: Audits conflicts from all domains.
 *
 * Two-stage pipeline:
 *  1. RELEVANCE FILTER — Remove any conflict that has no real factual connection
 *     to the user's client report. If a domain agent forced a match that doesn't
 *     make sense given the actual facts, it gets dropped here.
 *  2. CROSS-DOMAIN LINKER — For the surviving conflicts, identify cross-domain
 *     relationships (e.g., a criminal fraud that also triggers a tax audit).
 */
